...
const Workcard: React.FC<WorkcardProps> = ({ pic, title, link }) => {
    return (
        <div className='boxx md:w-[347px] lg:w-[377px] w-[338px] h-[195px] lg:[388px]'>
            <div className='flex flex-col boxs space-y-2  justify-center bg-black rounded-lg overflow-hidden text-[#E4E8F7] lg:w-[374px] md:w-[344px] w-[335px] h-[193px] absolute z-10'>
                <div className='relative'>
                    ...
                    <div className='absolute opacity-0 hover:opacity-100 transition-all ease-in duration-150 top-0 left-0 flex justify-center items-center w-full h-full flex-col bg-black p-10 bg-opacity-75 '>
                        ...
                        <Link className='btn mt-[26px]' href={link}>Project Link</Link>
                    </div>
                </div>
            </div>
        </div>
